            ...
            {!publicKey ? (
                ...
                <div className="flex items-center">
                    <button
                        ...
                        className="px-3 py-1.5 text-xs bg-cyan-500 hover:bg-cyan-600 text-white rounded-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2 font-medium cursor-pointer"
                    >
                        {isAuthenticating ? (
                            <>
