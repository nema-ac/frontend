  ...
  return (
    <footer className="bg-black/90 border-t border-cyan-400/30 mt-16">
      <div className="flex flex-row items-center justify-between gap-4 py-2">
        ...
        <div className="flex items-center space-x-4 pr-3 sm:pr-4 lg:pr-6">
            <a 
              href="https://t.me/deepwormportal" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center space-x-1.5 text-gray-300 hover:text-cyan-400 transition-colors duration-200 text-sm"
            >
