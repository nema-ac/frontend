...
import { calculateEmotionRanges } from '../utils/emotionCalculations.js';

const Worminal = () => {
  // Sample neural states data (same as used in EmotionVisualization)
  const sampleNeuralStates = [
    {
      motorNeurons: { 
  ...
  // Calculate emotion ranges from sample data for consistent normalization
  const emotionRanges = calculateEmotionRanges(sampleNeuralStates);
  ...
  return (
    <div className="min-h-screen bg-black text-white pt-28">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div className="mb-16">
          <ErrorBoundary>
            <InteractiveTerminal emotionRanges={emotionRanges} />
          </ErrorBoundary>
        </div>
        ...
        <div className="mb-16">
          <ErrorBoundary>
            <EmotionVisualization 
              neuralStates={sampleNeuralStates}
