    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="nema-card p-8">
          <h2 className="nema-display nema-display-2 max-md:nema-header-2 text-nema-cyan mb-6">MY ACCOUNT</h2>
          ...
          <div className="flex items-start space-x-8">
            ...
            <div className="flex-1 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-anonymous">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-textbox-background border border-textbox-border h-[40px] py-3 px-4 rounded-lg text-nema-white text-sm focus:outline-none focus:border-nema-cyan transition-colors"
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="flex-1 bg-textbox-background border border-textbox-border h-[40px] py-3 px-4 rounded-lg text-nema-white text-sm focus:outline-none focus:border-nema-cyan transition-colors"
              ...
              <div className="flex justify-between items-end w-full font-anonymous">
                <div>
                  <label className="block text-nema-gray-darker text-sm mb-1">Wallet Address</label>
                  <div className="px-3 py-2 flex items-center">
                    <code className="text-nema-white text-sm mr-2">
                      {contextProfile?.wallet_address}
                    </code>
                    <button className="text-nema-white hover:text-nema-cyan transition-colors">
                ...
                <div>
                  ...
                  <div className="px-3 py-2 flex items-center">
                    ...
                    <button
                      ...
                      className="text-nema-white hover:text-nema-cyan disabled:text-nema-secondary transition-colors ml-2"
                    >
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <label className="block text-nema-gray-darker text-sm mb-1">&nbsp;</label>
                  <button
                    onClick={handleDisconnect}
                    className="px-8 py-2 bg-nema-button-500 rounded-lg text-red-600 hover:bg-nema-button-600 transition-colors font-anonymous text-base cursor-pointer"
                  >
                    Disconnect Wallet
                  </button>
                </div>
